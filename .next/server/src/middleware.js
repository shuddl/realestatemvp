...
var import_auth_helpers_shared = __webpack_require__(240);
var supabase;
function createClientComponentClient({ supabaseUrl = "https://mock-supabase-url.supabase.co", supabaseKey = "mock-anon-key-for-demo-purposes-only", options, cookieOptions, isSingleton = true } = {}) {
...
var import_auth_helpers_shared2 = __webpack_require__(240);
...
function createPagesServerClient(context, { supabaseUrl = "https://mock-supabase-url.supabase.co", supabaseKey = "mock-anon-key-for-demo-purposes-only", options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
var import_auth_helpers_shared3 = __webpack_require__(240);
...
function createMiddlewareClient(context, { supabaseUrl = "https://mock-supabase-url.supabase.co", supabaseKey = "mock-anon-key-for-demo-purposes-only", options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
var import_auth_helpers_shared4 = __webpack_require__(240);
...
function createServerComponentClient(context, { supabaseUrl = "https://mock-supabase-url.supabase.co", supabaseKey = "mock-anon-key-for-demo-purposes-only", options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
var import_auth_helpers_shared5 = __webpack_require__(240);
...
function createRouteHandlerClient(context, { supabaseUrl = "https://mock-supabase-url.supabase.co", supabaseKey = "mock-anon-key-for-demo-purposes-only", options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
// src/deprecated.ts
function createBrowserSupabaseClient({ supabaseUrl = "https://mock-supabase-url.supabase.co", supabaseKey = "mock-anon-key-for-demo-purposes-only", options, cookieOptions } = {}) {
...
function createServerSupabaseClient(context, { supabaseUrl = "https://mock-supabase-url.supabase.co", supabaseKey = "mock-anon-key-for-demo-purposes-only", options, cookieOptions } = {}) {
...
function createMiddlewareSupabaseClient(context, { supabaseUrl = "https://mock-supabase-url.supabase.co", supabaseKey = "mock-anon-key-for-demo-purposes-only", options, cookieOptions } = {}) {
